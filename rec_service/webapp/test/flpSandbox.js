					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "맞춤영양제 추천",
									"targetURL": "#synczecrecservice-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synczecrecservice-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zec.recservice",
									"url": sap.ui.require.toUrl("sync/zec/recservice")
								}
							}
						}
					}
