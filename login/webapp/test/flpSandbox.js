		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ssp login",
									"targetURL": "#synczeclogin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczeclogin-display": {
								"semanticObject": "synczeclogin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zec.login",
									"url": sap.ui.require.toUrl("sync/zec/login")
								}
							}
						}
					}
