		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "계정잔액 조회 앱",
									"targetURL": "#synczecbalance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczecbalance-display": {
								"semanticObject": "synczecbalance",
								"action": "display",
								"description": "계정잔액 조회 앱",
								"title": "계정잔액 조회 앱",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zec.balance",
									"url": sap.ui.require.toUrl("sync/zec/balance")
								}
							}
						}
					}
