...
sap.ui.define([
    ...
    'sap/ui/VersionInfo',
    './ui5-version-utils'
], function (log, UI5ElementRegistry, __init, ___init_dialogs, ___sap_ux_private_control_property_editor_common, VersionInfo, ___ui5_version_utils) {
    'use strict';
    ...
    function getAllSyncViewsIds() {
        const elements = UI5ElementRegistry.all();
        const syncViewIds = [];
